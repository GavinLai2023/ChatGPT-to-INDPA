...
class WordPress:
    ...
    # Attention: wordpress plugin like "LiteSpeed Cache" may affect the execution of REST API
    ...
    # Attention: wordpress plugin like "Really Simple SSL" may affect the execution of REST API
